...
import { addEdge, ReactFlow, applyNodeChanges, applyEdgeChanges, Background, BackgroundVariant} from '@xyflow/react';
  ...
  return (
    <>
      ...
      <ReactFlow
        ...
        connectionLineStyle={{ stroke: 'var(--color-menu-border)', strokeWidth: 1 }}
        connectionRadius={7}
        fitView
        style={rfStyle}
      >
